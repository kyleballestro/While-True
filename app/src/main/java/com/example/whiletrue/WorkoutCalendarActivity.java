...
public class WorkoutCalendarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityTitle.setText("Workout Calendar");

        ImageView homeIcon = findViewById(R.id.homeIcon);
        homeIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(WorkoutCalendarActivity.this, MainActivity.class);
        ...
        calendar.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView calendarView, int year, int month, int day) {
                ...
                Intent intent = new Intent(WorkoutCalendarActivity.this, WorkoutDetailsActivity.class);
    ...
    public void onBackPressed() {
        if (this.equals(WorkoutCalendarActivity.this)) {
            Intent newIntent = new Intent(WorkoutCalendarActivity.this, MainActivity.class);
